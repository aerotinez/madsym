function matlabFunction(obj,name,states)
    ...
    S = jacobian(states.state,eom.States.independent.state);
    ...
    Sstr = dir_name + "/" + name + "SelectorMatrix";
    ...
    vars = {p};
    matlabFunction(S,"File",Sstr,"Comments",comment_str);
