function sys = prydeMotorcycleSlipLateralStateSpace(p)
   ...
   M = prydeMotorcycleSlipLateralSSMassMatrix(p);
   H = prydeMotorcycleSlipLateralSSForcingMatrix(p);
   G = prydeMotorcycleSlipLateralSSInputMatrix(p);
