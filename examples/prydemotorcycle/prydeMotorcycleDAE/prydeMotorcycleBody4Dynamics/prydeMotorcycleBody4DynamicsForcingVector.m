function f = prydeMotorcycleBody4DynamicsForcingVector(x,u,p)
   ...
   f0 = prydeMotorcycleBody4DynamicsCentrifugalForcingVector(x,p);
   f1 = prydeMotorcycleBody4DynamicsCoriolisForcingVector(x,p);
   f2 = prydeMotorcycleBody4DynamicsActiveForcingVector(x,u,p);
   f = f0 + f1 + f2;
