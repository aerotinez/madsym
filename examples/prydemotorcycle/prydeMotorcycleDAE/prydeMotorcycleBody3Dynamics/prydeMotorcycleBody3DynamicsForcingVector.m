function f = prydeMotorcycleBody3DynamicsForcingVector(x,u,p)
   ...
   f0 = prydeMotorcycleBody3DynamicsCentrifugalForcingVector(x,p);
   f1 = prydeMotorcycleBody3DynamicsCoriolisForcingVector(x,p);
   f2 = prydeMotorcycleBody3DynamicsActiveForcingVector(x,u,p);
   f = f0 + f1 + f2;
