function f = prydeMotorcycleBody1DynamicsForcingVector(x,u,p)
   ...
   f0 = prydeMotorcycleBody1DynamicsCentrifugalForcingVector(x,p);
   f1 = prydeMotorcycleBody1DynamicsCoriolisForcingVector(x,p);
   f2 = prydeMotorcycleBody1DynamicsActiveForcingVector(x,u,p);
   f = f0 + f1 + f2;
