function p = bikeSimToPrydeV2Parameters(bikesim_params,vx)
    ...
    p.lx = bs.SteeringHead.Rake;
    p.an = p.Rf*sin(p.caster) - p.lx;
    p.v = vx;
    ...
    qDzf1 = ft.Pacejka.qdz1;
    qDzf2 = ft.Pacejka.qdz2;
    qDzf8 = ft.Pacejka.qdz8;
    qDzf9 = ft.Pacejka.qdz9;
    ...
    qDzr1 = rt.Pacejka.qdz1;
    qDzr2 = rt.Pacejka.qdz2;
    qDzr8 = rt.Pacejka.qdz8;
    qDzr9 = rt.Pacejka.qdz9;
    ...
    %% Trim wheel speeds
    p.wf0 = p.v/p.Rf;
    p.wr0 = p.v*(p.Kxkr - p.fd)/(p.Kxkr*p.Rr);

    %% Relaxation lengths
    p.rlfx = ft.LongitudinalRelaxationLength;
    p.rlrx = rt.LongitudinalRelaxationLength;

    p.rlfy = ft.LateralRelaxationLength;
    p.rlry = rt.LateralRelaxationLength;
